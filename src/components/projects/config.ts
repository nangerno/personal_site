...
export const projectsEn: Project[] = [
  ...
  },
  {
    name: "Web3UIKit",
    description:
      "Open-source contributor to the Web3UIKit - Beautiful and lightweight UI components for web3 developers.",
    image: Web3UIKit,
  ...
  },
  {
    name: "Mobile Wallet",
    description:
      "Shows on-chain stats off user's address. User can add personal contacts for easy assets transfer.",
    image: Mobile,
    url: "",
    github: "https://github.com/nangerno/mobile-wallet",
    technologies: getSkill([
      "react native",
      "javascript",
      "moralis",
...
export const projectsSl: Project[] = [
  ...
  },
  {
    name: "Web3UIKit",
    description:
      "Odprtokodni sodelavec za Web3UIKit – čudovite in lahke komponente uporabniškega vmesnika za razvijalce web3 aplikacij.",
    image: Web3UIKit,
    url: "https://web3uikit.com/",
    github: "https://github.com/web3ui/web3uikit",
    technologies: getSkill([
  ...
  },
  {
    ...
    description:
      "Prikazuje on-chain statistiko uporabnika. Uporabnik lahko doda osebne kontakte za enostaveno pošiljanje žetonov.",
    image: Mobile,
    url: "",
    github: "https://github.com/nangerno/mobile-wallet",
    technologies: getSkill([
