...
export const hackathonsEn: Hackathon[] = [
  {
    ...
    project: "Cardix",
    prizes: [
      { name: "Chainlink Cloning Web2" },
      { name: "XMTP - most innovative" },
      { name: "Polygon Prize Pool" },
  ...
  },
  {
    ...
    description:
      "The most customizable solution for receiving automated recurring payments in cryptocurrencies.",
    image: Google,
    url: "https://bananapay.nangerno.dev/",
    project: "BananaPay",
    prizes: [
      { name: "BNB - Traditional Finance #1" },
      { name: "Fantom - DeFi++ #2" },
      { name: "Polygon Prize Pool" },
    ],
  },
...
export const hackathonsSl: Hackathon[] = [
  ...
  },
  {
    ...
    hackathonUrl: "https://moralis.io/google-hackathon/",
    description:
      "Najbolj prilagodljiva rešitev za prejemanje avtomatiziranih ponavljajočih se plačil v kriptovalutah.",
    image: Google,
    url: "https://bananapay.nangerno.dev/",
    project: "BananaPay",
    prizes: [
