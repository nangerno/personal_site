          ...
          return (
            <div key={uuidv4()} className="hackathon">
              ...
              <div className="hackathon-info">
                ...
                <Text fontSize="xl">{hackathon.description}</Text>
                <Text fontSize="xl" style={{ marginTop: "3px" }}>
                  {text[language].hackathonsProjectText}{" "}
                  ...
                  {hackathon.prizes.map((tech: { name: string }) => {
                    return (
                      <Tag
                        ...
                        className="tech-tag"
                      >
                        <Avatar size="xs" name={tech.name} ml={-1} mr={2} />
                ...
                <HStack>
                  ...
                  >
                    <Button size="md" colorScheme="blue" variant="solid">
                      {text[language].hackathonViewHackathon}
                    </Button>
                  </a>
                </HStack>
              </div>
